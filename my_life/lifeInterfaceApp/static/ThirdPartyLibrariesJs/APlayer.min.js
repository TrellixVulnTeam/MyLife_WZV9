!function (e, t) {
    ...
    return function (e) {
        ...
        var i = /mobile/i.test(window.navigator.userAgent), o = {
            secondToTime: function (e) {
                var t = function (e) {
                    return e < 10 ? "0" + e : "" + e
                }, n = Math.floor(e / 3600), a = Math.floor((e - 3600 * n) / 60), i = Math.floor(e - 3600 * n - 60 * a);
                return (n > 0 ? [n, a, i] : [a, i]).map(t).join(":")
            },
            ...
            getElementViewTop: function (e) {
                for (var t = e.offsetTop, n = e.offsetParent, a = 0; null !== n;) t += n.offsetTop, n = n.offsetParent;
            ...
            randomOrder: function () {
                ...
                return function (e) {
                    for (var t = e.length - 1; t >= 0; t--) {
                        var n = Math.floor(Math.random() * (t + 1)), a = e[n];
                        e[n] = e[t], e[t] = a
                    }
                    return e
                }([].concat(a(Array(e))).map(function (e, t) {
                    return t
                }))
            }
        };
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var i = n(11), o = a(i), r = n(12), s = a(r), l = n(13), u = a(l), c = n(14), p = a(c), d = n(15), h = a(d),
            f = n(16), y = a(f), v = n(17), m = a(v), g = n(18), w = a(g), b = n(19), M = a(b), x = n(20), T = a(x),
            k = n(21), L = a(k), _ = n(22), q = a(_), E = {
                play: o.default,
                pause: s.default,
                volumeUp: u.default,
        ...
        var a = n(6), i = function (e) {
            return e && e.__esModule ? e : {default: e}
        }(a);
        console.log("\n %c APlayer v1.7.0 375c0f7 %c http://aplayer.js.org \n\n", "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;"), t.default = i.default
    }, function (e, t) {
    }, function (e, t, n) {
        "use strict";
        ...
        var o = function () {
            ...
            }(), r = n(7), s = a(r), l = n(0), u = a(l), c = n(2), p = a(c), d = n(23), h = a(d), f = n(24), y = a(f),
            v = n(28), m = a(v), g = n(29), w = a(g), b = n(30), M = a(b), x = n(32), T = a(x), k = n(33), L = a(k),
            _ = n(34), q = a(_), E = [], O = function () {
                function e(t) {
                    if (i(this, e), this.options = (0, h.default)(t), this.container = this.options.container, this.playIndex = 0, this.paused = !0, this.playedPromise = s.default.resolve(), this.randomOrder = u.default.randomOrder(this.options.audio.length), this.container.classList.add("aplayer"), this.options.lrc && this.container.classList.add("aplayer-withlrc"), this.options.audio.length > 1 && this.container.classList.add("aplayer-withlist"), u.default.isMobile && this.container.classList.add("aplayer-mobile"), this.arrow = this.container.offsetWidth <= 300, this.arrow && this.container.classList.add("aplayer-arrow"), this.options.mini && this.container.classList.add("aplayer-narrow"), this.container = this.options.container, 2 === this.options.lrc || !0 === this.options.lrc) for (var n = this.container.getElementsByClassName("aplayer-lrc-content"), a = 0; a < n.length; a++) this.options.audio[a] && (this.options.audio[a].lrc = n[a].innerHTML);
                    this.template = new y.default({
                        container: this.container,
                        options: this.options,
                        randomOrder: this.randomOrder
                    }), this.template.info.offsetWidth < 200 && this.template.time.classList.add("aplayer-time-narrow"), this.options.lrc && (this.lrc = new M.default({
                        container: this.template.lrc,
                        async: 3 === this.options.lrc,
                        content: this.options.audio.map(function (e) {
                            return e.lrc
                        }),
                        player: this
                    })), this.events = new q.default, this.user = new w.default(this), this.bar = new m.default(this.template), this.controller = new T.default(this), this.timer = new L.default(this), this.initAudio(), "random" === this.options.order ? this.switchAudio(this.randomOrder[0]) : this.switchAudio(0), this.options.autoplay && this.play(), E.push(this)
                }
                ...
                return o(e, [{
                    key: "initAudio", value: function () {
                        ...
                        for (var t = 0; t < this.events.audioEvents.length; t++) !function (t) {
                            e.audio.addEventListener(e.events.audioEvents[t], function () {
                    ...
                    key: "switchAudio", value: function (e) {
                        ...
                        this.handlePlayPromise(function () {
                            t.events.trigger("switchaudio", e), void 0 !== e && (t.playIndex = e), t.options.audio[t.playIndex].cover ? t.template.pic.style.backgroundImage = "url('" + t.options.audio[t.playIndex].cover + "')" : t.template.pic.style.backgroundImage = "", t.template.title.innerHTML = t.options.audio[t.playIndex].name, t.template.author.innerHTML = t.options.audio[t.playIndex].artist ? " - " + t.options.audio[t.playIndex].artist : "";
                            var n = t.container.getElementsByClassName("aplayer-list-light")[0];
                            n && n.classList.remove("aplayer-list-light"), t.container.querySelectorAll(".aplayer-list li")[t.playIndex].classList.add("aplayer-list-light"), t.template.list.scrollTop = 33 * t.playIndex, t.audio.src = t.options.audio[t.playIndex].url, t.seek(0);
                            var a = void 0;
                            return t.paused || (a = s.default.resolve(t.audio.play()).catch(function (e) {
                                console.error(e), t.pause()
                            })), t.lrc && t.lrc.switch(t.playIndex), 1 !== t.audio.duration && (t.template.dtime.innerHTML = t.audio.duration ? u.default.secondToTime(t.audio.duration) : "00:00"), a
                        })
                    }
                }, {
                    key: "seek", value: function (e) {
                        e = Math.max(e, 0), this.audio.duration && (e = Math.min(e, this.audio.duration)), this.audio.currentTime = e, isNaN(this.audio.duration) ? this.bar.set("played", 0, "width") : this.bar.set("played", e / this.audio.duration, "width"), this.template.ptime.innerHTML = u.default.secondToTime(e)
                    }
                }, {
                    key: "play", value: function () {
                        var e = this;
                        this.handlePlayPromise(function () {
                            e.paused && (e.paused = !1, e.template.button.classList.remove("aplayer-play"), e.template.button.classList.add("aplayer-pause"), e.template.button.innerHTML = "", setTimeout(function () {
                                e.template.button.innerHTML = p.default.pause
                            }, 100));
                            var t = s.default.resolve(e.audio.play()).catch(function (t) {
                                console.error(t), e.pause()
                            });
                            if (e.timer.enable("loading"), e.timer.enable("progress"), e.options.mutex) for (var n = 0; n < E.length; n++) e !== E[n] && E[n].pause();
                            return t
                        })
                    }
                }, {
                    key: "pause", value: function () {
                        var e = this;
                        this.handlePlayPromise(function () {
                            e.paused || (e.paused = !0, e.template.button.classList.remove("aplayer-pause"), e.template.button.classList.add("aplayer-play"), e.template.button.innerHTML = "", setTimeout(function () {
                                e.template.button.innerHTML = p.default.play
                            }, 100)), e.audio.pause(), e.timer.disable("loading"), e.timer.disable("progress")
                        })
                    }
                }, {
                    ...
                    key: "volume", value: function (e, t) {
                        return e = parseFloat(e), isNaN(e) || (e = Math.max(e, 0), e = Math.min(e, 1), this.bar.set("volume", e, "height"), t || this.user.set("volume", e), this.audio.volume = e, this.audio.muted && (this.audio.muted = !1), this.switchVolumeIcon()), this.audio.muted ? 0 : this.audio.volume
                    }
                }, {
                    ...
                    key: "addAudio", value: function (e) {
                        ...
                        for (var n = "", a = 0; a < e.length; a++) n += '<li><span class="aplayer-list-cur" style="background: ' + this.options.theme + ';"></span><span class="aplayer-list-index">' + (this.options.audio.length - e.length + a + 1) + '</span><span class="aplayer-list-title">' + e[a].name + '</span><span class="aplayer-list-author">' + e[a].artist + "</span></li>";
                        this.template.listOl.innerHTML += n, t && this.isMultiple() && (this.container.classList.add("aplayer-withlist"), this.audio.loop = !1);
                        var i = this.container.querySelectorAll(".aplayer-list li").length;
                        this.template.list.style.height = 33 * i - 1 + "px", this.randomOrder = u.default.randomOrder(this.options.audio.length)
                    }
                }, {
                    key: "removeAudio", value: function (e) {
                        if (this.events.trigger("removeaudio", e), this.options.audio[e] && this.options.audio.length > 1) {
                            var t = this.container.querySelectorAll(".aplayer-list li");
                            this.options.audio.splice(e, 1), e === this.playIndex && (this.options.audio[e + 1] ? this.switchAudio(e) : this.switchAudio(e - 1)), this.playIndex > e && this.playIndex--, t[e].remove();
                            for (var n = e; n < t.length; n++) t[n].getElementsByClassName("aplayer-list-index")[0].textContent = n;
                            1 === this.options.audio.length && this.container.classList.remove("aplayer-withlist"), this.template.list.style.height = parseInt(this.template.list.style.height, 10) - 33 + "px"
                        }
                    }
                }, {
                    key: "destroy", value: function () {
                        E.splice(E.indexOf(this), 1), this.pause(), this.container.innerHTML = "", this.audio.src = "", this.timer.destroy(), this.events.trigger("destroy")
                    }
                }, {
                    key: "handlePlayPromise", value: function (e) {
        ...
        (function (t) {
            ...
            i.prototype.catch = function (e) {
                ...
                return new i(function (t, n) {
                    ...
                    for (var o = i.length, r = 0; r < i.length; r++) a(r, i[r])
                })
            }, i.resolve = function (e) {
                return e && "object" === (void 0 === e ? "undefined" : p(e)) && e.constructor === i ? e : new i(function (t) {
                    t(e)
                })
            }, i.reject = function (e) {
                return new i(function (t, n) {
                ...
                return new i(function (t, n) {
                    for (var a = 0, i = e.length; a < i; a++) e[a].then(t, n)
                })
        ...
        (function (e, t) {
            !function (e, n) {
                ...
                if (!e.setImmediate) {
                    ...
                    }(), d.setImmediate = a, d.clearImmediate = i
                }
        ...
        function o(e) {
            ...
            if ((p === a || !p) && setTimeout) return p = setTimeout, setTimeout(e, 0);
            try {
                return p(e, 0)
            } catch (t) {
                try {
        ...
        function s() {
            v && f && (v = !1, f.length ? y = f.concat(y) : m = -1, y.length && l())
        }
        ...
        !function () {
            try {
                p = "function" == typeof setTimeout ? setTimeout : a
            } catch (e) {
                p = a
            }
            try {
        ...
        h.nextTick = function (e) {
            ...
            y.push(new u(e, t)), 1 !== y.length || v || o(l)
        ...
        Object.defineProperty(t, "__esModule", {value: !0}), t.default = function (e) {
            ...
            return "[object Array]" !== Object.prototype.toString.call(e.audio) && (e.audio = [e.audio]), e.audio.map(function (e) {
                return e.name = e.name || e.title, e.artist = e.artist || e.author, e.cover = e.cover || e.pic, e
        ...
        }(), r = n(2), s = a(r), l = n(25), u = a(l), c = function () {
            function e(t) {
                i(this, e), this.container = t.container, this.options = t.options, this.randomOrder = t.randomOrder, this.init()
            }

            return o(e, [{
                key: "init", value: function () {
                    var e = void 0;
                    e = "random" === this.options.order ? this.options.audio[this.randomOrder[0]].cover : this.options.audio[0].cover, this.container.innerHTML = (0, u.default)({
                        options: this.options,
                        icons: s.default,
                        cover: e
                    }), this.lrc = this.container.querySelector(".aplayer-lrc-contents"), this.ptime = this.container.querySelector(".aplayer-ptime"), this.info = this.container.querySelector(".aplayer-info"), this.time = this.container.querySelector(".aplayer-time"), this.barWrap = this.container.querySelector(".aplayer-bar-wrap"), this.button = this.container.querySelector(".aplayer-button"), this.list = this.container.querySelector(".aplayer-list"), this.listOl = this.container.querySelector(".aplayer-list ol"), this.played = this.container.querySelector(".aplayer-played"), this.loaded = this.container.querySelector(".aplayer-loaded"), this.thumb = this.container.querySelector(".aplayer-thumb"), this.volume = this.container.querySelector(".aplayer-volume"), this.volumeBar = this.container.querySelector(".aplayer-volume-bar"), this.volumeButton = this.container.querySelector(".aplayer-time button"), this.volumeBarWrap = this.container.querySelector(".aplayer-volume-bar-wrap"), this.loop = this.container.querySelector(".aplayer-icon-loop"), this.order = this.container.querySelector(".aplayer-icon-order"), this.menu = this.container.querySelector(".aplayer-icon-menu"), this.pic = this.container.querySelector(".aplayer-pic"), this.title = this.container.querySelector(".aplayer-title"), this.author = this.container.querySelector(".aplayer-author"), this.dtime = this.container.querySelector(".aplayer-dtime")
                }
            }]), e
        }();
        t.default = c
        ...
        (function (t) {
            function a(e) {
                return "string" != typeof e && (e = void 0 === e || null === e ? "" : "function" == typeof e ? a(e.call(e)) : JSON.stringify(e)), e
            }

            function i(e) {
                var t = "" + e, n = s.exec(t);
                if (!n) return e;
                var a = "", i = void 0, o = void 0, r = void 0;
            ...
            var o = n(27), r = Object.create(o ? t : window), s = /["&'<>]/;
            r.$escape = function (e) {
                return i(a(e))
            }, r.$each = function (e, t) {
                if (Array.isArray(e)) for (var n = 0, a = e.length; n < a; n++) t(e[n], n); else for (var i in e) t(e[i], i)
            }, e.exports = r
        }).call(t, n(1))
    }, function (e, t, n) {
        "use strict";
        ...
        var i = function () {
            ...
            function e(t) {
                a(this, e), this.elements = {}, this.elements.volume = t.volume, this.elements.played = t.played, this.elements.loaded = t.loaded
            }
        ...
        var i = function () {
            ...
            function e(t) {
                a(this, e), this.storageName = {volume: "aplayer-volume"}, this.default = {volume: t.options.volume || .7}, this.data = {}, this.init()
            }
        ...
        var i = function () {
            ...
            function e(t) {
                a(this, e), this.container = t.container, this.async = t.async, this.player = t.player, this.content = t.content, this.parsed = [], this.index = 0, this.current = []
            }
            ...
            return i(e, [{
                ...
                key: "switch", value: function (e) {
                    ...
                    if (!this.parsed[e]) if (this.async) {
                        ...
                        n.onreadystatechange = function () {
                            4 === n.readyState && (n.status >= 200 && n.status < 300 || 304 === n.status ? t.parsed[e] = t.parse(n.responseText) : (console.log("Request was unsuccessful: " + n.status), t.parsed[e] = [["00:00", "Not available"]]), t.container.innerHTML = (0, r.default)({lyrics: t.parsed[e]}), t.update(0), t.current = t.parsed[e])
                        };
                        var a = this.content[e];
                        n.open("get", a, !0), n.send(null)
                    } else this.content[e] ? this.parsed[e] = this.parse(this.content[e]) : this.parsed[e] = [["00:00", "Not available"]];
                    this.container.innerHTML = (0, r.default)({lyrics: this.parsed[e]}), this.update(0), this.current = this.parsed[e]
                }
            }, {
                key: "parse", value: function (e) {
                    if (e) {
                        ...
                        for (var t = e.split("\n"), n = [], a = t.length, i = 0; i < a; i++) {
                            var o = t[i].match(/\[(\d{2}):(\d{2})(\.(\d{2,3}))?]/g),
                                r = t[i].replace(/.*\[(\d{2}):(\d{2})(\.(\d{2,3}))?]/g, "").replace(/<(\d{2}):(\d{2})(\.(\d{2,3}))?>/g, "").replace(/^\s+|\s+$/g, "");
                            if (o) for (var s = o.length, l = 0; l < s; l++) {
                                var u = /\[(\d{2}):(\d{2})(\.(\d{2,3}))?]/.exec(o[l]), c = 60 * u[1],
                                    p = parseInt(u[2]),
        ...
        e.exports = function (e) {
            "use strict";
            e = e || {};
            var t = "", n = a.$each, i = e.lyrics, o = (e.$value, e.$index, a.$escape);
        ...
        }(), r = n(0), s = a(r), l = n(2), u = a(l), c = function () {
            function e(t) {
                i(this, e), this.player = t, this.initPlayButton(), this.initList(), this.initPlayBar(), this.player.isMultiple() && this.initOrderButton(), this.initLoopButton(), this.initMenuButton(), s.default.isMobile || this.initVolumeButton()
            }
            ...
            return o(e, [{
                ...
                key: "initList", value: function () {
                    ...
                    this.player.template.list.addEventListener("click", function (t) {
                        ...
                        var a = parseInt(n.getElementsByClassName("aplayer-list-index")[0].innerHTML) - 1;
                        a !== e.player.playIndex ? (e.player.switchAudio(a), e.player.play()) : e.player.toggle()
                    })
                }
            }, {
                key: "initPlayBar", value: function () {
                    var e = this, t = function (t) {
                        var n = ((t.clientX || t.changedTouches[0].clientX) - s.default.getElementViewLeft(e.player.template.barWrap)) / e.player.template.barWrap.clientWidth;
                        n = Math.max(n, 0), n = Math.min(n, 1), e.player.bar.set("played", n, "width"), e.player.lrc && e.player.lrc.update(n * e.player.audio.duration), e.player.template.ptime.innerHTML = s.default.secondToTime(n * e.player.audio.duration)
                    }, n = function n(a) {
                        document.removeEventListener(s.default.nameMap.dragEnd, n), document.removeEventListener(s.default.nameMap.dragMove, t);
                        var i = ((a.clientX || a.changedTouches[0].clientX) - s.default.getElementViewLeft(e.player.template.barWrap)) / e.player.template.barWrap.clientWidth;
                        i = Math.max(i, 0), i = Math.min(i, 1), e.player.bar.set("played", i, "width"), e.player.seek(e.player.bar.get("played", "width") * e.player.audio.duration), e.player.timer.enable("progress")
                    };
                    this.player.template.barWrap.addEventListener(s.default.nameMap.dragStart, function () {
                        e.player.timer.disable("progress"), document.addEventListener(s.default.nameMap.dragMove, t), document.addEventListener(s.default.nameMap.dragEnd, n)
                    })
                }
            }, {
                key: "initVolumeButton", value: function () {
                    ...
                    var t = function (t) {
                        var n = 1 - ((t.clientY || t.changedTouches[0].clientY) - s.default.getElementViewTop(e.player.template.volumeBar)) / e.player.template.volumeBar.clientHeight;
                        n = Math.max(n, 0), n = Math.min(n, 1), e.player.volume(n)
                    }, n = function n(a) {
                        e.player.template.volumeBarWrap.classList.remove("aplayer-volume-bar-wrap-active"), document.removeEventListener(s.default.nameMap.dragEnd, n), document.removeEventListener(s.default.nameMap.dragMove, t);
                        var i = 1 - ((a.clientY || a.changedTouches[0].clientY) - s.default.getElementViewTop(e.player.template.volumeBar)) / e.player.template.volumeBar.clientHeight;
                        i = Math.max(i, 0), i = Math.min(i, 1), e.player.volume(i)
                    };
                    this.player.template.volumeBarWrap.addEventListener(s.default.nameMap.dragStart, function () {
                        e.player.template.volumeBarWrap.classList.add("aplayer-volume-bar-wrap-active"), document.addEventListener(s.default.nameMap.dragMove, t), document.addEventListener(s.default.nameMap.dragEnd, n)
                    })
                }
            }, {
                key: "initOrderButton", value: function () {
                    ...
                    this.player.template.order.addEventListener("click", function () {
                        "list" === e.player.options.order ? (e.player.options.order = "random", e.player.template.order.innerHTML = u.default.orderRandom) : "random" === e.player.options.order && (e.player.options.order = "list", e.player.template.order.innerHTML = u.default.orderList)
                    })
                }
            }, {
                key: "initLoopButton", value: function () {
                    ...
                    this.player.template.loop.addEventListener("click", function () {
                        e.player.isMultiple() ? "one" === e.player.options.loop ? (e.player.options.loop = "none", e.player.template.loop.innerHTML = u.default.loopNone) : "none" === e.player.options.loop ? (e.player.options.loop = "all", e.player.template.loop.innerHTML = u.default.loopAll) : "all" === e.player.options.loop && (e.player.options.loop = "one", e.player.template.loop.innerHTML = u.default.loopOne) : "one" === e.player.options.loop || "all" === e.player.options.loop ? (e.player.options.loop = "none", e.player.template.loop.innerHTML = u.default.loopNone) : "none" === e.player.options.loop && (e.player.options.loop = "all", e.player.template.loop.innerHTML = u.default.loopAll)
                    })
                }
            }, {
                key: "initMenuButton", value: function () {
                    var e = this;
                    this.player.template.list.style.height = 33 * this.player.options.audio.length - 1 + "px", this.player.template.menu.addEventListener("click", function () {
        ...
        var i = function () {
            ...
            function e(t) {
                a(this, e), this.player = t, window.requestAnimationFrame = function () {
                    return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (e) {
                        window.setTimeout(e, 1e3 / 60)
                    }
                }(), this.types = ["loading", "progress"], this.init()
            }
                ...
                key: "initprogressChecker", value: function () {
                    ...
                    this.progressChecker = setInterval(function () {
                        if (e.enableprogressChecker) {
                            e.player.bar.set("played", e.player.audio.currentTime / e.player.audio.duration, "width"), e.player.lrc && e.player.lrc.update();
                            var t = r.default.secondToTime(e.player.audio.currentTime);
                            e.player.template.ptime.innerHTML !== t && (e.player.template.ptime.innerHTML = t)
                        }
                    }, 100)
                }
            }, {
                key: "initloadingChecker", value: function () {
                    var e = this, t = 0, n = 0, a = !1;
                    this.loadingChecker = setInterval(function () {
                        e.enableloadingChecker && (n = e.player.audio.currentTime, a || n !== t || e.player.audio.paused || (e.player.container.classList.add("aplayer-loading"), a = !0), a && n > t && !e.player.audio.paused && (e.player.container.classList.remove("aplayer-loading"), a = !1), t = n)
                    }, 100)
                }
            }, {
        ...
        var i = function () {
            ...
            function e() {
                a(this, e), this.events = {}, this.audioEvents = ["abort", "canplay", "canplaythrough", "durationchange", "emptied", "ended", "error", "loadeddata", "loadedmetadata", "loadstart", "mozaudioavailable", "pause", "play", "playing", "progress", "ratechange", "seeked", "seeking", "stalled", "suspend", "timeupdate", "volumechange", "waiting"], this.playerEvents = ["destroy", "switchaudio", "addaudio", "removeaudio"]
            }
